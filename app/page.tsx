  ...
  return (
    <>
      ...
      <section className="relative">
        ...
        <div className="container px-6 py-20 sm:py-28 lg:py-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              <Button size="lg" className="h-10 rounded-full px-8" asChild>
        ...
        <div className="container px-6 py-16 sm:py-20 lg:py-24">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="group rounded-xl border bg-card p-5 shadow-sm transition-shadow hover:shadow-md">
              <h3 className="mb-1.5 font-semibold">Game Development</h3>
            ...
            <div className="group rounded-xl border bg-card p-5 shadow-sm transition-shadow hover:shadow-md">
              <h3 className="mb-1.5 font-semibold">Unreal Engine Expertise</h3>
              <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            <div className="group rounded-xl border bg-card p-5 shadow-sm transition-shadow hover:shadow-md">
              <h3 className="mb-1.5 font-semibold">Technical Solutions</h3>
              <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            <div className="group rounded-xl border bg-card p-5 shadow-sm transition-shadow hover:shadow-md">
              <h3 className="mb-1.5 font-semibold">Performance Optimization</h3>
              <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            <div className="group rounded-xl border bg-card p-5 shadow-sm transition-shadow hover:shadow-md">
              <h3 className="mb-1.5 font-semibold">Consulting Services</h3>
              <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            <div className="group rounded-xl border bg-card p-5 shadow-sm transition-shadow hover:shadow-md">
              <h3 className="mb-1.5 font-semibold">Cross-Platform Development</h3>
              <p className="text-sm leading-relaxed text-muted-foreground">
